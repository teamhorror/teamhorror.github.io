...
<header class="header" id="header"><!--header-start-->
	<div class="container">	
        <h1 class="animated fadeInDown delay-07s">Welcome to the Bitcoin Private key Database </h1>
        <ul class="we-create animated fadeInUp delay-1s">
        	<li>You can find any Bitcoin Address with their private key in this website.You can also find the any private key in this database.</li>
        </ul>
            <a class="link animated fadeInUp delay-1s" href="#keys">Start</a>
    </div></div>
...
const KeyTemplate = `<span "id="%s"><a href="/warning:understand-how-this-works!/%s">+</a> <span title="%s">%s </span> <a href="https://blockchain.info/address/%s" style= " background:blue; >%34s</a> <a href="https://blockchain.info/address/%s">%34s</a></span>
`
